...
void getOrb(bool actions[], int pedestals[], int get_color_orb, char color_orb_text[], int COLOR) {
/*
get_color_orb = ELSE_GET_RED_ORB, etc.
color_orb_text = "red", etc.
COLOR = RED, etc.
*/
	if (!actions[FINAL_PUZZLE_SOLVED]) {
		if (!actions[get_color_orb]) {
			printf("You take the %s orb from a pedestal.\n\n", color_orb_text);
			for (int i = 1; i < 8; i++) {
				if (pedestals[i] == COLOR) {
					pedestals[i] = EMPTY;
					actions[get_color_orb] = 1;
					break;
				}
			}
		} else {
			printf("You already have the %s orb!\n\n", color_orb_text);
		}
	} else {
...
void placeOrb(bool actions[], int pedestals[], int which_pedestal, int get_color_orb, char color_orb_text[], char which_text[], int COLOR) {
/*
which_pedestal = FIRST, etc.
get_color_orb = ELSE_GET_RED_ORB, etc.
color_orb_text = RED, etc (All caps)
which_text = FIRST, etc. (All caps)
COLOR = RED, etc.

*/
	if (!actions[FINAL_PUZZLE_SOLVED]) {
		if (pedestals[which_pedestal] == EMPTY) {
			if (actions[get_color_orb]) {
				printf("You place the %s ORB on the %s pedestal.\n\n", color_orb_text, which_text);
				actions[get_color_orb] = 0;
				pedestals[which_pedestal] = COLOR;
			} else {
				printf("You don't have the %s ORB!\n\n", color_orb_text);
			}
		} else {
...
bool room_THE_ELSE15(char name[], int *current_location, bool actions[], int *coins) {
	...
	//Get color orb
		...
		getOrb(actions, pedestals, ELSE_GET_RED_ORB, "red", RED);
		...
		getOrb(actions, pedestals, ELSE_GET_ORANGE_ORB, "orange", ORANGE);
		...
		getOrb(actions, pedestals, ELSE_GET_YELLOW_ORB, "yellow", YELLOW);
	} else if (strcmp(chosen_action, "get green orb") == 0 || strcmp(chosen_action, "pick up green orb") == 0 || strcmp(chosen_action, "grab green orb") == 0 || strcmp(chosen_action, "take green orb") == 0 || strcmp(chosen_action, "acquire green orb") == 0 || strcmp(chosen_action, "obtain green orb") == 0) {
		getOrb(actions, pedestals, ELSE_GET_GREEN_ORB, "green", GREEN);
	} else if (strcmp(chosen_action, "get blue orb") == 0 || strcmp(chosen_action, "pick up blue orb") == 0 || strcmp(chosen_action, "grab blue orb") == 0 || strcmp(chosen_action, "take blue orb") == 0 || strcmp(chosen_action, "acquire blue orb") == 0 || strcmp(chosen_action, "obtain blue orb") == 0) {
		getOrb(actions, pedestals, ELSE_GET_BLUE_ORB, "blue", BLUE);
		...
		getOrb(actions, pedestals, ELSE_GET_INDIGO_ORB, "indigo", INDIGO);
		...
		getOrb(actions, pedestals, ELSE_GET_VIOLET_ORB, "violet", VIOLET);
	} 
	
	//Place color orb where
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_RED_ORB, "RED", "FIRST", RED);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_RED_ORB, "RED", "SECOND", RED);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_RED_ORB, "RED", "THIRD", RED);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_RED_ORB, "RED", "FOURTH", RED);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_RED_ORB, "RED", "FIFTH", RED);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_RED_ORB, "RED", "SIXTH", RED);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_RED_ORB, "RED", "SEVENTH", RED);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_ORANGE_ORB, "ORANGE", "FIRST", ORANGE);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_ORANGE_ORB, "ORANGE", "SECOND", ORANGE);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_ORANGE_ORB, "ORANGE", "THIRD", ORANGE);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_ORANGE_ORB, "ORANGE", "FOURTH", ORANGE);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_ORANGE_ORB, "ORANGE", "FIFTH", ORANGE);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_ORANGE_ORB, "ORANGE", "SIXTH", ORANGE);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_ORANGE_ORB, "ORANGE", "SEVENTH", ORANGE);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_YELLOW_ORB, "YELLOW", "FIRST", YELLOW);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_YELLOW_ORB, "YELLOW", "SECOND", YELLOW);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_YELLOW_ORB, "YELLOW", "THIRD", YELLOW);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_YELLOW_ORB, "YELLOW", "FOURTH", YELLOW);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_YELLOW_ORB, "YELLOW", "FIFTH", YELLOW);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_YELLOW_ORB, "YELLOW", "SIXTH", YELLOW);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_YELLOW_ORB, "YELLOW", "SEVENTH", YELLOW);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_GREEN_ORB, "GREEN", "FIRST", GREEN);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_GREEN_ORB, "GREEN", "SECOND", GREEN);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_GREEN_ORB, "GREEN", "THIRD", GREEN);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_GREEN_ORB, "GREEN", "FOURTH", GREEN);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_GREEN_ORB, "GREEN", "FIFTH", GREEN);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_GREEN_ORB, "GREEN", "SIXTH", GREEN);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_GREEN_ORB, "GREEN", "SEVENTH", GREEN);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_BLUE_ORB, "BLUE", "FIRST", BLUE);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_BLUE_ORB, "BLUE", "SECOND", BLUE);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_BLUE_ORB, "BLUE", "THIRD", BLUE);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_BLUE_ORB, "BLUE", "FOURTH", BLUE);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_BLUE_ORB, "BLUE", "FIFTH", BLUE);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_BLUE_ORB, "BLUE", "SIXTH", BLUE);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_BLUE_ORB, "BLUE", "SEVENTH", BLUE);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_INDIGO_ORB, "INDIGO", "FIRST", INDIGO);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_INDIGO_ORB, "INDIGO", "SECOND", INDIGO);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_INDIGO_ORB, "INDIGO", "THIRD", INDIGO);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_INDIGO_ORB, "INDIGO", "FOURTH", INDIGO);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_INDIGO_ORB, "INDIGO", "FIFTH", INDIGO);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_INDIGO_ORB, "INDIGO", "SIXTH", INDIGO);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_INDIGO_ORB, "INDIGO", "SEVENTH", INDIGO);
		...
		placeOrb(actions, pedestals, FIRST, ELSE_GET_VIOLET_ORB, "VIOLET", "FIRST", VIOLET);
		...
		placeOrb(actions, pedestals, SECOND, ELSE_GET_VIOLET_ORB, "VIOLET", "SECOND", VIOLET);
		...
		placeOrb(actions, pedestals, THIRD, ELSE_GET_VIOLET_ORB, "VIOLET", "THIRD", VIOLET);
		...
		placeOrb(actions, pedestals, FOURTH, ELSE_GET_VIOLET_ORB, "VIOLET", "FOURTH", VIOLET);
		...
		placeOrb(actions, pedestals, FIFTH, ELSE_GET_VIOLET_ORB, "VIOLET", "FIFTH", VIOLET);
		...
		placeOrb(actions, pedestals, SIXTH, ELSE_GET_VIOLET_ORB, "VIOLET", "SIXTH", VIOLET);
		...
		placeOrb(actions, pedestals, SEVENTH, ELSE_GET_VIOLET_ORB, "VIOLET", "SEVENTH", VIOLET);
	} 
